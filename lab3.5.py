...
output_file = r'C:\Users\mini_\OneDrive\Documentos\Code Test\TEST 1\lab3\cueri.txt'
# Ruta al archivo de salida TRUNCADO
output_file_final = r'C:\Users\mini_\OneDrive\Documentos\Code Test\TEST 1\lab3\cueri-TRUNCADO.txt'
...
archivo_path = os.path.join(os.path.dirname(__file__), 'cueri.txt')
